...
export class DataService {
  private jsonData = {
    "images": [
      ...
      { "name": "Dungeon Master Kovas", "perfil": "../../assets/Image/Dm.png","fullimg": "../../assets/Image/Kovas_Avatar.png", "description": "DM y Wordbuilder de Dungeons and master, desde hace mas de 4 año. Narro la historia de estos 4 personaje en Reinos olvidados, la campaña de 'Reliquias del pasado'" ,"number": "5"},
    ]
  };
